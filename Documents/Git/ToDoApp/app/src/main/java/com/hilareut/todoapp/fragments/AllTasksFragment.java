...
import com.hilareut.todoapp.activities.DisplayTaskActivity;
import com.hilareut.todoapp.activities.MainActivity;
...
import com.hilareut.todoapp.bl.TaskListFragmentAdapter;
import com.parse.ParseUser;

import java.util.List;

public class AllTasksFragment extends Fragment implements ItemLongClickListener,
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mRecyclerView.setAdapter(activity.mAllTasksAdapter);
        mAdapter = activity.mAllTasksAdapter;

        //number of tasks
        TextView view = (TextView) rootView.findViewById(R.id.numberOfWaitingTask);
        view.setText(Integer.toString(activity.mAllTasksAdapter.getItemCount()));
    ...
    public void onClick(View view, int pos, boolean flag) {
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                MainActivity activity = (MainActivity) getActivity();
                activity.mAllTasksAdapter.notifyDataSetChanged();
    ...
    public boolean onOptionsItemSelected(MenuItem item){
        ...
        switch(item.getItemId())
        {
            ...
            case R.id.checkForNewTasks:
                ...
                List updatedlist = mydb.getAllTasks(user);
