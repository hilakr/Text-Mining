...
public class LoginActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState){
        ...
        eUserNameView = (EditText) findViewById(R.id.editTextUserName);
        ...
        findViewById(R.id.login_button).setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
              ...
              // If there is a validation error, display the error
                ...
                ParseUser.logInInBackground(eUserNameView.getText().toString(), ePasswordView.getText()
                    ...
                    public void done(ParseUser user, ParseException e) {
                        ...
                        if (e != null) {
                            ...
                            //First login
                            if (ParseUser.getCurrentUser().get("firstlogin") == 0)
                            {
                                Toast.makeText(LoginActivity.this, "You have been added to Team", Toast.LENGTH_LONG).show();
                            }
